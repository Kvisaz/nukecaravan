...
function WorldState(stats) {
    ...
    // мощность каравана и текущий вес рассчитывается слушателем WeightCheck,
    // здесь эти элементы декларируются для понимания, что они используются (в UI и при расчете движения)
    this.capacity = 0;
    this.weight = 0;
}